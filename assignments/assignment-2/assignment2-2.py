...
if value.isdigit(): # checks if input is correct
    ...
    if value % 2 == 0: # checks if value is even
        print("You entered an odd number that is a multiple of 7") # confirms that even number was entered
    elif value % 7 == 0: # else if value is a multiple of 7
        print("You entered a number that is NOT a multiple of 7") # print that it is now a multiple of 7
    else: # otherwise
